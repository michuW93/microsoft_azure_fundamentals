...
Text translation - translate text or documents to another language. Azure AI translator is ONLY focused on text-to-text translation, it supports over 90 langauges. Also we can translate documents to another language, extension doesn't matter e.g pdf, excel, word. You can also create custom translation.
...
The Custom Vision service can't be used to analyze videos. <br>
