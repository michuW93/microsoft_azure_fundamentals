...
![alt text](https://github.com/michuW93/microsoft_azure_fundamentals-AZ-900-/az-900/blob/master/old_servers.png?raw=true)
...
# Azure regions
<b>Azure region - a geographical area containing one or more datacenters networked together with a low-latency network and are in close proximity</b>
...
Availability zones - Physically separate locations withing an Azure region
...
11. What's the leagal agreement between Azure customer and Microsoft secure and process data? <b>Data Protection Addendum (DPA)</b>
...
24. <b>In compliance manager</b> you can track your company’s regulatory standards and regulations, such as ISO27001.
